...
const LIVE_TABLE = [
  ...
  { feature: 'VOC 대시보드', mode: '내장 샘플', how: '가상 통화 10건의 사전 라벨 집계 (실시간 누적은 개선 예정)' },
  { feature: 'LLM 분석·QA 정성 평가·RAG 답변', mode: '키 등록 시 라이브', how: 'CLAUDE_API_KEY 미등록 시 규칙 기반 데모 응답 + 배지 표시' },
]
